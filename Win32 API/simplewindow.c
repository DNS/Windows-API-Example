...
INT WINAPI wWinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, INT nCmdShow) {
	...
	hwnd = CreateWindowExW(WS_EX_WINDOWEDGE | WS_EX_ACCEPTFILES | WS_EX_CONTROLPARENT | WS_EX_TOPMOST,
		...
		//WS_OVERLAPPED | WS_MINIMIZEBOX | WS_SYSMENU,						// non-resizable window
		WS_VISIBLE | WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_TABSTOP,	// resizable window
...
LRESULT CALLBACK WindowProc (HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
	...
	switch (msg) {
		case WM_CREATE:
			//CenterWindow(hwnd);	// alternative: CW_USEDEFAULT
		...
		case WM_COMMAND:
			switch(LOWORD(wParam)) {
				case IDM_FILE_NEW:
					...
					break;
				case IDM_HELP_ABOUT:
					ShellExecuteW(NULL, L"open", L"http://github.com/dns/", NULL, NULL, SW_SHOWNORMAL);
					break;
